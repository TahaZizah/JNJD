  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative">
        <div className="glass rounded-xl px-5 md:px-7 py-4 md:py-6 min-w-[78px] md:min-w-[110px]">
          <div className="t-display text-5xl md:text-7xl gold-text tabular-nums text-center">{pad(value)}</div>
        </div>
        <div className="absolute inset-x-4 top-1/2 h-px bg-ink-950/60" />
      </div>
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10 pt-40 pb-24 lg:pt-48 lg:pb-32">
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-8">
            <Reveal delay={80}>
              <h1 className="t-display text-[72px] md:text-[120px] lg:text-[168px]">
          ...
          <div className="lg:col-span-7">
            <Reveal delay={120}>
              <div className="flex items-end gap-3 md:gap-5 flex-wrap">
                ...
                <span className="t-display text-5xl md:text-7xl text-gold-600/60 pb-8">:</span>
                ...
                <div className="flex flex-wrap gap-3">
                  <Magnetic>
                    <a href="#register" className="btn-primary">
                      Register a team <IconArrow size={16} />
                    </a>
                  </Magnetic>
                  <Magnetic>
