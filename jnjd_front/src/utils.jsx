...
const { motion, AnimatePresence, useMotionValue, useTransform, useScroll, useSpring } = window.Motion || window.framerMotion || window['framer-motion'] || {};
...
Object.assign(window, { EVENT_DATE, useCountdown, pad, useInView, Reveal, Stagger, Magnetic });
