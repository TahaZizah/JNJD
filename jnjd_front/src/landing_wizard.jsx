      ...
      >
        {value ? (
          <div className="flex items-center justify-center gap-3">
            <IconFile size={18} className="text-gold-400" />
          ...
          <React.Fragment key={s.id}>
            ...
            >
              <span className={`t-mono text-[10px] w-6 h-6 rounded-full grid place-items-center border transition ${
                ...
                {done ? <IconCheck size={12} /> : <span>{String(i+1).padStart(2,'0')}</span>}
              </span>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div className="glass-gold rounded-3xl p-14 text-center max-w-3xl mx-auto">
            <div className="w-16 h-16 mx-auto rounded-full grid place-items-center mb-8" style={{
              ...
              <IconCheck size={24} className="text-gold-300" />
            </div>
            ...
            <button onClick={() => { setSubmitted(false); setStep(0); }} className="btn-ghost">
              Register another team <IconArrow size={14} />
            </button>
          </div>
        </div>
      </section>
            ...
            <Reveal>
              ...
              <div className="mt-8 glass rounded-2xl p-5 hair-b">
                ...
                <ul className="space-y-2 text-sm text-bone-100/75">
                  <li className="flex items-center gap-2"><IconCheck size={12} className="text-gold-400" /> Team name & category</li>
                  <li className="flex items-center gap-2"><IconCheck size={12} className="text-gold-400" /> 3 members (name, email, year)</li>
                  <li className="flex items-center gap-2"><IconCheck size={12} className="text-gold-400" /> Scanned student IDs (PDF/JPG)</li>
                  <li className="flex items-center gap-2"><IconCheck size={12} className="text-gold-400" /> ~6 minutes</li>
                </ul>
              </div>
            </Reveal>
          </div>
          ...
          <div className="lg:col-span-8">
            <Reveal delay={120}>
              ...
              <div className="flex items-center justify-between mt-6">
                ...
                >
                  {step === WIZARD_STEPS.length - 1 ? 'Submit registration' : 'Continue'} <IconArrow size={14} />
                </button>
              </div>
            </Reveal>
          </div>
