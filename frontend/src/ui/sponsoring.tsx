              ...
              <div className="flex flex-wrap gap-3">
                <Magnetic>
                  <a className="btn-primary" href="#tiers">
                    See the formulas <Icons.IconArrow size={14} />
                  </a>
                </Magnetic>
                <Magnetic>
                  <a className="btn-ghost" href="#contact">
                    <Icons.IconDownload size={14} /> Download the brochure
                  </a>
                </Magnetic>
              </div>
            </Reveal>
          ...
          <Reveal delay={80}>
            <div className="glass rounded-3xl p-8 md:p-10 lift h-full">
              <div className="flex items-center justify-between mb-6">
                ...
                <Icons.IconLayers size={22} className="text-gold-400" />
              </div>
          ...
          <Reveal delay={160}>
            <div className="glass rounded-3xl p-8 md:p-10 lift h-full">
              <div className="flex items-center justify-between mb-6">
                ...
                <Icons.IconCircuit size={22} className="text-gold-400" />
              </div>
          ...
          {reasons.map((r, i) => (
            <Reveal key={i} delay={i * 80} className={i === 0 ? 'lg:col-span-3' : i === 1 ? 'lg:col-span-3' : 'lg:col-span-2'}>
              <div className="glass rounded-2xl p-7 lift h-full relative overflow-hidden">
                <div className="absolute -right-4 -top-4 t-display text-[100px] md:text-[120px] text-gold-500/5 leading-none select-none">{r.n}</div>
                ...
                <div className={`${featured ? 'tier-featured' : 'glass lift'} rounded-3xl p-8 md:p-10 h-full flex flex-col relative overflow-hidden`}>
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {featured && <Icons.IconCrown size={22} className="text-gold-300" />}
                    </div>
                  ...
                  <div className="mt-8 pt-6 hair-bottom" style={{ borderBottom: 'none', borderTop: '1px solid rgba(201,168,76,0.15)' }}>
                    <button className={featured ? 'btn-primary w-full justify-center' : 'btn-ghost w-full justify-center'}>
                      Become {t.name} <Icons.IconArrow size={14} />
                    </button>
                  </div>
                </div>
              </Reveal>
            ...
            <Reveal delay={80}>
              <div className="glass rounded-3xl p-8 md:p-10">
                ...
                <div className="mt-6 flex items-center justify-between flex-wrap gap-4">
                  ...
                  <Magnetic>
                    <button className="btn-primary">Send brief <Icons.IconArrow size={14} /></button>
                  </Magnetic>
                </div>
              </div>
            </Reveal>
